...
exampleModal.addEventListener('show.bs.modal', function (event) {
  ...
  var form_id = button.getAttribute('data-bs-data');
  var title = button.getAttribute('data-bs-title');
  var modalContent = exampleModal.querySelector('#modal_body_content');
  var btn_submit = exampleModal.querySelector('#btn_submit');
  btn_submit.addEventListener("click", function () {
    document.querySelector("#".concat(form_id)).submit();
  });
  modalContent.innerHTML = "Are you sure you want to delete <span class=\"fw-bold text-decoration-underline text-danger\">".concat(title, "</span>");
});
var btn_calendar = document.querySelectorAll('.btn-calendar');
btn_calendar.forEach(function (btn) {
